...
import Cart from "../components/cart/steps/cart";
import DeliveryAddress from "../components/cart/steps/delivery-address";
import CheckOut from "../components/cart/steps/check-out";
import { createShopOrder } from "../@core/api/shopApi";
const steps = [
  {
    number: 1,
    label: "My Cart",
